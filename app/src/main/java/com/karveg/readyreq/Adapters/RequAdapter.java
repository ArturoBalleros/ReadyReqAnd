...
public class RequAdapter extends RecyclerView.Adapter<RequAdapter.ViewHolder> {
    ...
    public RequAdapter(List<Generic> objects, int id, int layout, Context context, int mode, AlertDialog progressDialog) {
    ...
    @Override
    public RequAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(layout, parent, false);
        RequAdapter.ViewHolder vh = new RequAdapter.ViewHolder(v);
        return vh;
    }

    //solo se ejecuta al crear
    @Override
    public void onBindViewHolder(RequAdapter.ViewHolder holder, int position) {
        ...
        private final PopupMenu.OnMenuItemClickListener optionMenu = new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.delItem:
                        Utils.showCtxDelete(objects, getAdapterPosition(), id, ctx, mode, MyApplication.REQU, progressDialog);
                        break;
                }
                return true;
            }
