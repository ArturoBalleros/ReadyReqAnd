...
public class SecExcAdapter extends RecyclerView.Adapter<SecExcAdapter.ViewHolder> implements ItemTouchHelperAdapter {

    //Atributos
    private static List<Generic> objects;
    private int layout;
    private SecExcAdapter.ICallback listener;

    public SecExcAdapter(List<Generic> objects, int layout, SecExcAdapter.ICallback listener) {
    ...
    @Override
    public SecExcAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(layout, parent, false);
        SecExcAdapter.ViewHolder vh = new SecExcAdapter.ViewHolder(v);
        return vh;
    }

    //solo se ejecuta al crear
    @Override
    public void onBindViewHolder(SecExcAdapter.ViewHolder holder, int position) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements ItemTouchHelperViewHolder {
        ...
        public void bind(final Generic object, final SecExcAdapter.ICallback listener) {
            //Procesamos
