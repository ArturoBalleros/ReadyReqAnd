...
public class ObjecFragment extends Fragment {
    ...
    public ObjecFragment() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public ObjecFragment(int mode, Objective objective) {
        this.mode = mode;
        this.objective = objective;
    }

    @SuppressLint("ValidFragment")
    public ObjecFragment(int mode, ReqFun reqfun) {
        this.mode = mode;
        this.reqfun = reqfun;
    }

    @SuppressLint("ValidFragment")
    public ObjecFragment(int mode, ReqNFun reqnfun) {
        this.mode = mode;
        this.reqnfun = reqnfun;
    }

    @SuppressLint("ValidFragment")
    public ObjecFragment(int mode, ReqInfo reqinfo) {
        this.mode = mode;
    ...
    public static void updateRecyclerView() {
        ...
        mAdapter = new ObjeAdapter(objects, id, R.layout.cardview_default, ctx, mode, progressDialog);
    ...
    private void addItemTab() {
        ...
        i.putExtra("flagTab", MyApplication.OBJE);
    ...
    private void getListObject() {
        if (mode == MyApplication.OBJETIVOS) objects = objective.getObjetives();
        if (mode == MyApplication.REQ_FUNC) objects = reqfun.getObjetives();
        if (mode == MyApplication.REQ_NO_FUN) objects = reqnfun.getObjetives();
        if (mode == MyApplication.REQ_INFO) objects = reqinfo.getObjetives();
    }
}