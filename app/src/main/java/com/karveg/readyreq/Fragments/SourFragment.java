...
public class SourFragment extends Fragment {
    ...
    public SourFragment(int mode, Actor actor) {
        this.mode = mode;
        this.actor = actor;
    }

    @SuppressLint("ValidFragment")
    public SourFragment(int mode, Objective objective) {
        this.mode = mode;
        this.objective = objective;
    }

    @SuppressLint("ValidFragment")
    public SourFragment(int mode, ReqFun reqfun) {
        this.mode = mode;
        this.reqfun = reqfun;
    }

    @SuppressLint("ValidFragment")
    public SourFragment(int mode, ReqNFun reqnfun) {
        this.mode = mode;
        this.reqnfun = reqnfun;
    }

    @SuppressLint("ValidFragment")
    public SourFragment(int mode, ReqInfo reqinfo) {
        this.mode = mode;
