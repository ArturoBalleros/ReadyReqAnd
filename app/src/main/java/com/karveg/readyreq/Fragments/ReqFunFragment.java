...
public class ReqFunFragment extends Fragment {
    ...
    public static void setValuesReque() {
        ...
        if (radioButtonVer.isChecked())
            reqfun.setState(true);
        else
            reqfun.setState(false);
