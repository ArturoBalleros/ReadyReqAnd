...
public class SecNorFragment extends Fragment {
    ...
    private static SecNorAdapter mAdapter;
    ...
    public SecNorFragment() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public SecNorFragment(int mode, ReqFun reqfun) {
        this.reqfun = reqfun;
        this.mode = mode;
    }
    ...
    public static void updateRecyclerView() {
        mAdapter = new SecNorAdapter(objects, R.layout.cardview_default, new SecNorAdapter.ICallback() {
            @Override
    ...
    public void Events() {
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Utils.showAlertForItem(objects, getContext(), MyApplication.SEC_NOR, reqfun.getId());
            }
        });
        fabDel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Utils.showDeleteItems(objects, reqfun.getId(), getContext(), mode, MyApplication.SEC_NOR, progressDialog);
            }
        });
